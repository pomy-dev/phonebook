        ...
        if (activeCategory !== "More...") {
            const filtered = businesses.filter((business) => {
                ...
                const matchesSearch =
                    ...
                    business.company_type.toLowerCase().includes(searchQuery.toLowerCase().trim()) ||
                    business.address.toLowerCase().includes(searchQuery.toLowerCase().trim());
                return matchesCategory && matchesSearch;
            });
            setFilteredBusinesses(filtered);
        } else {
            console.log("Navigating to BusinessList screen within the Countries stack...");
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.sectionContainer}>
                    <View style={styles.sectionHeader}>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate("Featured", { featuredBusinesses })}>
                        ...
                        {featuredBusinesses.map((item) => (
                            ...
                            >
                                <View style={styles.featuredImageContainer}>
                                    {item.logo ? (
                                        <Image source={{ uri: item.logo }} style={styles.featuredImage} resizeMode="contain" />
                                    ) : (
                                        <View style={styles.placeholderContent}>
                                            <Text style={styles.placeholderText}>{item.company_name.charAt(0)}</Text>
                                        </View>
                                    )}
                                </View>
                                ...
                                >
                                    <View style={styles.favoriteHeader}>
                                        ...
                                        <View style={styles.businessInfo}>
                                            ...
                                            <Text style={styles.businessCategory} numberOfLines={1} ellipsizeMode="tail">
                                                {item.company_type}
                                            </Text>
                                            <Text style={styles.businessAddress} numberOfLines={1} ellipsizeMode="tail">
                                                {item.address}
                                            </Text>
                                        </View>
