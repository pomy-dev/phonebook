...
export const mockPromotions = [
  {
    ...
    ads: [
      {
        id: "1-1",
        title: "50% Off AI Analytics Suite",
        teaser: "Boost your business with discounted AI tools.",
        image: Images.RstpAd1,
      ...
      {
        id: "1-2",
        title: "Free Cloud Storage Trial",
        teaser: "Try our cloud services for 30 days, free!",
        image: Images.RstpAd2,
        description: "Sign up for a 30-day free trial of our secure cloud storage solutions. No commitment required.",
        validUntil: "2025-08-31",
      },
      {
        id: "1-3",
        title: "Tech Summit 2025",
        teaser: "Join us for innovation and networking.",
        image: Images.RstpAd3,
        description: "Attend the RSTP Tech Summit 2025 in Mbabane. Connect with industry leaders and explore cutting-edge tech.",
  ...
  },
  {
    ...
    phoneNumbers: [
      { type: "Call", number: "+27112345678" },
      { type: "WhatsApp", number: "+27119876543" },
      { type: "Support", number: "+27110012345" },
    ],
  ...
  },
  {
    ...
    ads: [
      ...
      {
        id: "4-3",
        title: "Family Data Bundle",
        teaser: "Share data with your loved ones.",
        image: Images.MozTelAd3,
        description: "Get our family data bundle and share 50GB with up to 5 family members.",
        validUntil: "2025-09-15",
      },
    ],
  },
  ...
  },
  {
    ...
    phoneNumbers: [
      { type: "Call", number: "+26826012345" },
      { type: "WhatsApp", number: "+26826067890" },
      { type: "Support", number: "+26826054321" },
    ],
    email: "contact@swaziagri.co.sz",
    ads: [
      {
        ...
        teaser: "Boost your crops with 20% off.",
        image: Images.SwaziAgriAd1,
  ...
  {
    id: "7",
    name: "Maputo Logistics",
    industry: "Logistics",
    logo: Images.MaputoLogisticsLogo,
    country: "Mozambique",
    phoneNumbers: [
      { type: "Call", number: "+25883123456" },
    ],
    email: "info@maputologistics.co.mz",
    ads: [
      {
        id: "7-1",
        title: "Free Shipping for New Clients",
        teaser: "Ship your goods at no cost.",
        image: Images.MaputoLogisticsAd1,
      ...
      },
      {
        ...
        image: Images.MaputoLogisticsAd2,
      ...
      },
      {
        ...
        image: Images.MaputoLogisticsAd3,
  ...
  },
  {
    ...
    ads: [
      ...
      },
      {
        ...
        image: Images.AfriTechAd2,
        description: "Join our free blockchain workshop for businesses in Johannesburg.",
        validUntil: "2025-08-31",
      },
      {
        id: "8-3",
        title: "AI Chatbot Discount",
        teaser: "Automate customer service and save.",
        image: Images.AfriTechAd3,
        description: "Get 25% off our AI chatbot solutions for the first year.",
        validUntil: "2025-09-15",
      },
    ],
  },
  {
    id: "9",
    name: "Eswatini Health",
    industry: "Healthcare",
    logo: Images.EswatiniHealthLogo,
    country: "eSwatini",
    phoneNumbers: [
      { type: "Call", number: "+26827012345" },
      { type: "WhatsApp", number: "+26827067890" },
    ...
    ads: [
      {
        ...
        teaser: "Smile brighter with free checkups.",
        image: Images.EswatiniHealthAd1,
        description: "Visit our clinics for a free dental checkup this month. Limited slots available.",
        validUntil: "2025-09-10",
      },
      {
        id: "9-2",
        title: "Discounted Health Plans",
        teaser: "Affordable healthcare for families.",
        image: Images.EswatiniHealthAd2,
        description: "Sign up for our family health plans at 15% off for the first year.",
        validUntil: "2025-08-31",
      },
      {
        id: "9-3",
        title: "Mental Health Seminar",
        teaser: "Free seminar on well-being.",
        image: Images.EswatiniHealthAd3,
        description: "Attend our free mental health seminar to learn stress management techniques.",
        validUntil: "2025-09-20",
      },
    ],
  },
  {
    ...
    logo: Images.MozBuildLogo,
    country: "Mozambique",
    phoneNumbers: [
      { type: "Call", number: "+25885123456" },
      { type: "WhatsApp", number: "+25885134567" },
      { type: "Office", number: "+25885167890" },
    ],
    email: "contact@mozbuild.co.mz",
    ads: [
      {
        id: "10-1",
        title: "Affordable Housing Promo",
        teaser: "Own a home with low deposits.",
        image: Images.MozBuildAd1,
        description: "Purchase a home in our new Beira complex with a 10% deposit discount.",
        validUntil: "2025-09-30",
      },
      {
        id: "10-2",
        title: "Free Construction Consultation",
        teaser: "Plan your project with experts.",
        image: Images.MozBuildAd2,
        description: "Get a free consultation for your construction project. Limited offer.",
        validUntil: "2025-08-31",
      },
      {
        id: "10-3",
        title: "Eco-Friendly Building Discount",
        teaser: "Build green and save 20%.",
        image: Images.MozBuildAd3,
        description: "Use our sustainable building materials and save 20% on your next project.",
        validUntil: "2025-09-15",
      },
    ],
  },
